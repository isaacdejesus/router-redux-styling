...
//deconstruct to remove resetf
    const {resetf: resetContent, ..._content} = content
    const {resetf: resetAuthor, ..._author} = author
    const {resetf: resetInfo, ..._info} = info
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
            <input name="content" {..._content} />
        </div>
        <div>
          author
            <input name="author" {..._author}/>
        </div>
        <div>
          url for more info
            <input name="info" {..._info} />
        </div>
